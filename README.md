...
Productivity Tip: Keep the phone away during high-priority sessions and complete one task before switching to another.
...
Procedure:
Identify the personal problem to be solved using an LLM.
Select academic planning as the application area.
Define the main assistant features.
Create simple prompts for basic study planning.
Refine prompts by adding subjects, priorities, deadlines, and available study time.
Generate responses using ChatGPT or other LLM tools.
Develop a simple web-based interface to simulate interaction with the assistant.
Allow the user to enter tasks and priorities.
Generate a study plan based on the entered information.
Modify future recommendations according to user preferences.
Analyze how prompt refinement improves output quality.
...
Suggested Productivity Tip: Keep your phone away during focused study sessions.
